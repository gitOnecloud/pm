...
public class WebAuthenticationDetails implements Serializable {
    ...
    public WebAuthenticationDetails(HttpServletRequest request) {
        ...
        this.broswer = StaticMethod.getBrowser(request);
    }
	...
	public boolean equals(Object obj) {
        if (obj instanceof WebAuthenticationDetails) {
            ...
            if ((broswer == null) && (rhs.getBroswer() != null)) {
                return false;
            }
            if ((broswer != null) && (rhs.getBroswer() == null)) {
                return false;
            ...
            if (broswer != null) {
                if (!broswer.equals(rhs.getBroswer())) {
                    return false;
                }
            }
	...
	public int hashCode() {
        ...
        if (this.broswer != null) {
            code = code * (this.broswer.hashCode() % 7);
        }
	...
	public String toString() {
        ...
        sb.append("Broswer: ").append(this.getBroswer());
