...
public class SessionRegistryImpl implements SessionRegistry, ApplicationListener<SessionDestroyedEvent> {
    ...
    @Override
	public void registerNewSession(String sessionId, String remoteIp, String browser, Object principal) {
        Assert.hasText(sessionId, "SessionId required as per interface contract");
        ...
        sessionIds.put(sessionId, new SessionInformation(principal, sessionId, remoteIp, browser, new Date()));
