...
public class CasAuthenticationProvider implements AuthenticationProvider, InitializingBean, MessageSourceAware {
	...
	private com.baodian.model.user.User user;
    ...
    private CasAuthenticationToken authenticateNow(final Authentication authentication) throws AuthenticationException {
        try {
            ...
            //用户注册信息 @update
            this.user = ((UsernamePasswordAuthenticationToken) authentication).getUser();
    ...
    protected UserDetails loadUserByAssertion(final Assertion assertion) {
    	// @update
        final CasAssertionAuthenticationToken token =
        		new CasAssertionAuthenticationToken(assertion, "", this.user);
