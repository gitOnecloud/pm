...
public final class CentralAuthenticationServiceImpl implements CentralAuthenticationService {
     ...
     * @update
     */
    public String getUserName(String ticketId) {
    	List<Authentication> authentications = this.serviceTicketRegistry.getTicket(ticketId)
    			.getGrantingTicket().getChainedAuthentications();
    	return authentications.get(authentications.size()-1).getPrincipal().getId();
    }
