...
<script type="text/javascript" src="<c:url value="/js/rsa-encode.js" />"></script>
<script type="text/javascript" src="<c:url value="/js/jquery.encoding.digests.sha1.js" />"></script>
...
<div id="msg" class="errors">
  ...
  <div class="box fl-panel" id="login">
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row btn-row">
						<input type="hidden" name="lt" id="loginTicket" value="${loginTicket}" />
			...
			<input type="hidden" name="rsa_pubKey" id="rsa_pubKey" value="${rsa_pubKey}" />
			<input type="hidden" name="rsa_modKey" id="rsa_modKey" value="${rsa_modKey}" />
          </div>
            <div id="sidebar">
